			...
			<div className="main-contex1 about-app-wrapper">
				<Row gutter={{ xs: 8, sm: 16, md: 10, lg: 40, xl: 80, xxl: 100 }}>
					<Col xl={9} lg={10} md={16} span={24}>
						<h5 className="mb-4 fw-bold">Great deals are always nearby</h5>
						<p className="">Be the first to know about great deals in the TezTop app</p>
						<div className="row">
							<div className="col-6">
					...
					<Col xl={8} lg={8} md={24} sm={18} span={17}>
						<div className="qr-code-map">
							<div className="d-flex justify-content-start align-items-center">
								...
								<div className="ps-">
									<p>
										Point your camera at the QR code <br /> to download the application
									</p>
								</div>
							</div>
						</div>
